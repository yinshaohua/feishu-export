@echo off
set "EXTERNAL_NODE_MODULES=C:/local_data/feishu-export/node_modules"
set "EXTERNAL_NODE_BIN=%EXTERNAL_NODE_MODULES%/.bin"

set "FEISHU_EXPORT_NODE_MODULES=%EXTERNAL_NODE_MODULES%"
...
echo FEISHU_EXPORT_NODE_MODULES=%FEISHU_EXPORT_NODE_MODULES%
